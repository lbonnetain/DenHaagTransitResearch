function plotSpaceTimeDiagram_OneDayOneLine_originaldata(TripDetail,TripSummary,routeCellArray,GraphSpec,diagramType)
...
curTitle = ['Line ' int2str(GraphSpec.lineID) ' to ' GraphSpec.destName...
           ' (' int2str(GraphSpec.dirID) '), ' GraphSpec.date,' original data'];
title(curTitle);
...
%     
    ...
    if length(avlArr)==1 && length(avlDep)==1 && isexecuted & inferr==0
